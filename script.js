...
(function(){
  // --- Contador ---
  const matchDate = new Date('2026-09-01T15:40:00'); // ajustar si se desea
  ...
  function updateCountdown(){
    ...
    if(nextMatchText) nextMatchText.innerHTML = 'Próximo partido: <strong>1 de septiembre de 2026</strong>';
