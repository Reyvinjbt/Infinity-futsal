...
(function(){
  // --- Contador ---
  const matchDate = new Date('2026-09-18T14:20:00'); // ajustar si se desea
  ...
  function updateCountdown(){
    ...
    if(nextMatchText) nextMatchText.innerHTML = 'Próximo partido: <strong>18 de septiembre de 2026</strong>';
