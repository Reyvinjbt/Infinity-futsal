...
(function(){
  // --- Contador ---
  const matchDate = new Date('2026-09-04T17:00:00'); // ajustar si se desea
  ...
  function updateCountdown(){
    ...
    if(nextMatchText) nextMatchText.innerHTML = 'Próximo partido: <strong>4 de septiembre de 2026</strong>';
