...
(function(){
  // --- Contador ---
  const matchDate = new Date('2026-08-28T00:00:00'); // ajustar si se desea
  ...
  function updateCountdown(){
    ...
    if(nextMatchText) nextMatchText.innerHTML = 'Próximo partido: <strong>28 de agosto de 2026</strong>';
